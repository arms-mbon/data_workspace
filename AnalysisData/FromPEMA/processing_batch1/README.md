In here are the input and output files from the first batch of runs on the ARMS-MBON sequences, that were executed in April 2022 for data largely from 2018 to 2020 
